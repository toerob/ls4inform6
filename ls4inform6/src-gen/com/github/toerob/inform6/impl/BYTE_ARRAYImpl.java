 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.toerob.inform6.impl.BYTE_ARRAYImpl#getContent <em>Content</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BYTE_ARRAYImpl extends ArrayTypeImpl implements BYTE_ARRAY
{
  /**
  ...
  {
    return Inform6Package.Literals.BYTE_ARRAY;
  }
  ...
  public EList<PrimaryExpression> getContent()
  {
    if (content == null)
    {
      content = new EObjectContainmentEList<PrimaryExpression>(PrimaryExpression.class, this, Inform6Package.BYTE_ARRAY__CONTENT);
    }
    return content;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Inform6Package.BYTE_ARRAY__CONTENT:
