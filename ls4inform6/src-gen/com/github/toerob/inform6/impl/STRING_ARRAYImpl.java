 ...
 * </p>
 * <ul>
 *   <li>{@link com.github.toerob.inform6.impl.STRING_ARRAYImpl#getSize <em>Size</em>}</li>
...
public class STRING_ARRAYImpl extends ArrayTypeImpl implements STRING_ARRAY
{
  ...
  public NotificationChain basicSetSize(Primary newSize, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, Inform6Package.STRING_ARRAY__SIZE, oldSize, newSize);
  ...
  public void setSize(Primary newSize)
  {
    if (newSize != size)
    {
      ...
      if (size != null)
        msgs = ((InternalEObject)size).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - Inform6Package.STRING_ARRAY__SIZE, null, msgs);
      if (newSize != null)
        msgs = ((InternalEObject)newSize).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - Inform6Package.STRING_ARRAY__SIZE, null, msgs);
      msgs = basicSetSize(newSize, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, Inform6Package.STRING_ARRAY__SIZE, newSize, newSize));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case Inform6Package.STRING_ARRAY__SIZE:
